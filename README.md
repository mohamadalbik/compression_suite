...
## Screenshots
![Main Window](screenshots/main-window.png) ## Technologies
- C++
- Qt Framework
- OpenCV
- MinGW Compiler
...
If you don't have OpenCV pre-built with MinGW, follow these steps: 1. Download the OpenCV source from [opencv.org(https://opencv.org/releases/) 
2. Open CMake GUI 
